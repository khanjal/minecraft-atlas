...
async function main(): Promise<void> {
    ...
    console.log(`Fetching and parsing items/entities/effects/enchantments/blocks/biomes for ${version}...`);

    const [items, entities, effects, enchantments, blocks, biomes] = await Promise.all([
        buildItems(version),
